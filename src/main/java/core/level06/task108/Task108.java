package main.java.core.level06.task108;
 ...
 * Вам нужно узнать, сколько целых предметов можно изготовить из этой массы, если каждый предмет весит определённую часть килограмма.
 ...
 * Явно преобразуйте значение totalMaterialWeight к типу int и сохраните результат в переменной completeItemsCount.
 * Затем выведите полученное количество целых предметов на экран.
 * Требования:
